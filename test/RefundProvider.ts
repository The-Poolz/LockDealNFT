...
describe("Refund Provider", function () {
    ...
    let BUSD: string
    let params: [number, number, number, number, number, BigNumber]
    ...
    beforeEach(async () => {
        ...
        let rate = ethers.utils.parseEther('0.9');
        params = [amount, startTime, finishTime, amount / 2, (startTime + halfTime), rate]
